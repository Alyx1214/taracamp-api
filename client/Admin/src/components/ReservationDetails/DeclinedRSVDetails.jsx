...
export default function DeclinedRSVDetails() {
  ...
  // Helper: determine which documents to display (same rules as PendingRSVDetails)
          ...
          <tbody>
            ...
            {requiredDocs.showMoa && (
              <tr>
                ...
                <td>
                  {reservation.moaFile ? (
                    <a href={reservation.moaFile} className={styles["rsv-details-link"]} target="_blank" rel="noopener noreferrer">
                      Click to open
                    </a>
                  ) : (
            ...
            {reservation.serviceContractFile && (
              <tr>
                ...
                <td className={styles["rsv-details-separator"]}>:</td>
                <td>
                  <a href={reservation.serviceContractFile} className={styles["rsv-details-link"]} target="_blank" rel="noopener noreferrer">
                    Click to open
                  </a>
                </td>
              </tr>
            ...
            {requiredDocs.showCaf && (
              <tr>
                ...
                <td>
                  {reservation.cafFile ? (
                    <a href={reservation.cafFile} className={styles["rsv-details-link"]} target="_blank" rel="noopener noreferrer">
                      Click to open
                    </a>
                  ) : (
                    <span className={styles["rsv-details-placeholder"]}>Not uploaded</span>
              ...
              <tr>
                ...
                <td>
                  {reservation.letterOfIntentFile ? (
                    <a href={reservation.letterOfIntentFile} className={styles["rsv-details-link"]} target="_blank" rel="noopener noreferrer">
                      Click to open
                    </a>
                  ) : (
                    <span className={styles["rsv-details-placeholder"]}>Not uploaded</span>
              ...
              <tr>
                ...
                <td>
                  {reservation.governmentIdFile ? (
                    <a href={reservation.governmentIdFile} className={styles["rsv-details-link"]} target="_blank" rel="noopener noreferrer">
                      Click to open
                    </a>
                  ) : (
                    <span className={styles["rsv-details-placeholder"]}>Not uploaded</span>
            ...
            {requiredDocs.showDepEdId && (
              <tr>
                <td className={styles["rsv-details-label"]}>DepEd/Government ID</td>
                <td className={styles["rsv-details-separator"]}>:</td>
                <td>
                  {reservation.depedIdFile ? (
                    <a href={reservation.depedIdFile} className={styles["rsv-details-link"]} target="_blank" rel="noopener noreferrer">
                      Click to open
                    </a>
                  ) : (
                    <span className={styles["rsv-details-placeholder"]}>Not uploaded</span>
              ...
              <tr>
                ...
                <td>
                  {reservation.pwdIdFile ? (
                    <a href={reservation.pwdIdFile} className={styles["rsv-details-link"]} target="_blank" rel="noopener noreferrer">
                      Click to open
                    </a>
                  ) : (
                    <span className={styles["rsv-details-placeholder"]}>Not uploaded</span>
              ...
              <tr>
                ...
                <td>
                  {reservation.scIdFile ? (
                    <a href={reservation.scIdFile} className={styles["rsv-details-link"]} target="_blank" rel="noopener noreferrer">
                      Click to open
                    </a>
                  ) : (
                    <span className={styles["rsv-details-placeholder"]}>Not uploaded</span>
