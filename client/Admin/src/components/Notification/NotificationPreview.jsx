...
export default function NotificationPreview({
  ...
  const body =
    notif.message ||
    (isApproved
      ? "Your reservation has been approved. Please proceed with payment or upload required documents to confirm your booking."
        ...
        {isApproved && onConfirm && (
          <>
            ...
            <button
              ...
              disabled={loading || facilityLoading || !notif.reservationId || !action}
            >
              {confirmLabel}
            </button>
